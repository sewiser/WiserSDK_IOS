Pod::Spec.new do |s|
  ...
  s.source_files = 'WiserSmartMessageKit.xcframework/ios-arm64/WiserSmartMessageKit.framework/Headers/*'

  s.vendored_frameworks = 'WiserSmartMessageKit.xcframework'
