...
/**
 ...
 @return preCondition
 */
+ (WiserSmartScenePreConditionModel *)creatAllDayPreConditionWithSceneId:(NSString *)sceneId existConditionId:(NSString * __nullable)conditionId loops:(NSString *)loops timeZoneId:(NSString *)timeZoneId;
...
/**
 ...
 @return preCondition
 */
+ (WiserSmartScenePreConditionModel *)createDayTimePreConditionWithSceneId:(NSString *)sceneId existConditionId:(NSString * __nullable)conditionId loops:(NSString *)loops cityId:(NSString *)cityId cityName:(NSString *)cityName timeZoneId:(NSString *)timeZoneId;
...
/**
 ...
 @return preCondition
 */
+ (WiserSmartScenePreConditionModel *)createNightTimePreConditionWithSceneId:(NSString *)sceneId existConditionId:(NSString * __nullable)conditionId loops:(NSString *)loops cityId:(NSString *)cityId cityName:(NSString *)cityName timeZoneId:(NSString *)timeZoneId;
...
/**
 ...
 @return preCondition
 */
+ (WiserSmartScenePreConditionModel *)createCustomTimePreConditionWithSceneId:(NSString *)sceneId existConditionId:(NSString * __nullable)conditionId loops:(NSString *)loops cityId:(NSString *)cityId cityName:(NSString *)cityName timeZoneId:(NSString *)timeZoneId beginTime:(NSString *)begin endTime:(NSString *)end;
